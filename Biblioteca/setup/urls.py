...
urlpatterns = [
    ...
    path('emprestimos/<int:pk>/livros/', Emprestimo_Lista_Livro.as_view(), name='emprestimo_livro'),
    path('emprestimos/<int:pk>/usuarios/', Emprestimo_Lista_Usuario.as_view(), name='emprestimo_usuario'),
]
